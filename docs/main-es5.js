...
module.exports = "\n<div class=\"ae-masonry ae-masonry-md-2 ae-masonry-xl-4\">\n    <a *ngFor=\"let producto of productosService.productoFiltrado\" [routerLink]=\"['/item', producto.cod]\" class=\"animated fadeIn rk-item ae-masonry__item\">\n      <img src=\"../../../assets/productos/{{producto.url}}.jpg\" alt=\"\">\n      <div class=\"item-meta\">\n        <h2>{{producto.titulo}}</h2>\n        <p>{{producto.categoria}}</p>\n      </div>\n    </a>   \n  </div>\n"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(infoPaginaSevice, productosServices) {
        this.infoPaginaSevice = infoPaginaSevice;
...
var ProductosService = /** @class */ (function () {
    ...
    ProductosService.prototype.cargarProductos = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.http.get('https://angular-html-45640.firebaseio.com/productos_idx.json')
    ...
    ProductosService.prototype.getProducto = function (id) {
        return this.http.get("https://angular-html-45640.firebaseio.com/productos/" + id + ".json");
    };
    ProductosService.prototype.buscarProducto = function (termino) {
        ...
        if (this.productos.length === 0) {
            ...
            this.cargarProductos().then(function () {
                //ejecutar despues de que tengamos registros
                //aplicar filter
...
module.exports = __webpack_require__(/*! C:\Users\Hp\Documents\Angular\portafolio\src\main.ts */"./src/main.ts");
